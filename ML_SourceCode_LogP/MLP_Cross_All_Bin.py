...
parameters = {'solver': ['adam','lbfgs'], 'max_iter': [600, 1000,1400], 'alpha': 10.0 ** -np.arange(1,10,2), 'hidden_layer_sizes':np.arange(80, 160, 20), 'random_state':[3,6,8], "activation": ["logistic", "relu"]}
